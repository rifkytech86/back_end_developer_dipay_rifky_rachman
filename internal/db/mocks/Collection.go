...
// CreateOne provides a mock function with given fields: ctx, document
func (_m *Collection) CreateOne(ctx context.Context, document mongo.IndexModel) (string, error) {
